...
namespace TIAGroupCopyCLI.Models
{
    ...
    class SavedAttribute : ParentInstance
    {
        ...
        public SavedAttribute(ParentInstance parent)
        {
        ...
        public SavedAttribute(ParentInstance parent, string name, object value, AttributeType type = AttributeType.Undefined, AttributeLocation location = null) : this(parent)
        {
            Name = name;
            Value = value;
            Type = type;
        ...
        {
            object value = GetAttributeWrapper(device, device?.Name, attributeName);
            if (value != null)
            {
    ...
    //=========================================================================================================
    class SaveAttributeGroup : ParentInstance
    {
        ...
        public SaveAttributeGroup(ParentInstance parent) : this()
        {
            Parent = parent;
        }
        #endregion Constructor
